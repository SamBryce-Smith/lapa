...
@click.option('--disable_internal_priming_filter',
              ...
              is_flag=True)
@click.option('--upstream_window',
              help='Number of bases upstream of the poly(A) site to search '
              'for poly(A) signal sequences.',
              default=60,
              type=int)
@click.option('--downstream_window',
              help='Number of bases downstream of the poly(A) site to search '
              'for poly(A) signal sequences.',
              default=10,
              type=int)
